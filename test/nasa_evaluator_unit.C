...
// CEA
    ...
    return_flag_temp = test_cp( species_name + " CEA", index, cea_cp_N2_1, T1, thermo );
    if( return_flag_temp != 0 ) return_flag = 1;

    return_flag_temp = test_cp( species_name + " CEA", index, cea_cp_N2_2, T2, thermo );
    if( return_flag_temp != 0 ) return_flag = 1;

    return_flag_temp = test_cp( species_name + " CEA", index, cea_cp_N2_3, T3, thermo );
    if( return_flag_temp != 0 ) return_flag = 1;
...
// NASA [300 - 1000] [1000 - 5000]
    ...
    return_flag_temp = test_cp( species_name + " NASA", index, nasa_cp_N2_1, T4, nasa_thermo );
    if( return_flag_temp != 0 ) return_flag = 1;

    return_flag_temp = test_cp( species_name + " NASA", index, nasa_cp_N2_2, T2, nasa_thermo );
    if( return_flag_temp != 0 ) return_flag = 1;
